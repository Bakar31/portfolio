  ...
  <div className="hoverable-card group">
    <div className="flex gap-4">
      <Image
        ...
        alt={item.institute}
      />
      <div className="flex sm:hidden flex-col gap-2 text-sm font-light mt-2 w-64">
    ...
    <div className="flex flex-grow flex-col sm:group-hover:ml-4 transition-all duration-500">
    ...
    <div className="hidden sm:flex flex-col gap-2 text-sm font-light mt-2 w-64">
      <div className="flex gap-2 items-center">
        <FaMapMarkerAlt className="hoverable-card-icon" />
        <span className="hoverable-card-text">{item.location}</span>
      </div>
